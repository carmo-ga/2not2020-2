...
/*
    ...
    2) Essa função será chamada dentro do bubbleSort(), recebendo o elemento da posição atual e da posição seguinte como parêmetros.
...
// localeCompare() faz corretamente a ordenação considerando os acentos, mas é MUITO mais lento do que a comparação binária padrão
