...
// fnComp é a função de comparação
...
function mergeSort(vetor, fnComp) {
    ...
    // Recebe dois vetores JÁ ORDENADOS PREVIAMENTE e os mescla em um único vetor, também ORDENADO
    function mesclarVetores(vetEsq, vetDir) {
        ...
        // slice(): retorna um subvetor a partir da posição especificada até o final
