// Aula 19/11/2020, 26/11/2020 e 27/11/2020
class Node {
    constructor(value) {
        this.data = value
...
module.exports = class BinarySearchTree {
    ...
    // Verifica se um determinado valor (key) existe na árvore. Retorna true caso exista e false caso contrário
    search(key) {
        return this.searchNode(this.root, key)
    }

    // Vefica se existe algum nodo, a partir de uma dada raiz (root), que contenha o valor especificado em key. Retorna true caso exista e false caso contrário
    searchNode(root, key) {
    ...
    // Manda excluir o nodo com o key especificado (caso exista) e retorna a raiz da árvore, que pode ter mudado
    remove(key) {
        this.root = this.removeNode(this.root, key)
    }

    // Encontra e exclui o nodo (caso exista) com o key especificado e retorna a raiz da árvore, que pode ter mudado
    removeNode(root, key) {
        // Caso 1: árvore vazia
        ...
        // Caso 4: key é igual ao data do root (encontrou o nodo a ser removido)
            ...
            // Caso 4d: exclusão de nodo de grau 2
                ...
                // É preciso encontrar o nodo com o MAIOR valor do lado ESQUERDO ou aquele com o MENOR valor do lado DIREITO
                ...
                // Manda excluir o nodo que era o menor do lado direito, pois seu valor já está na raiz da subárvore e seu valor, neste momento, está duplicado na árvore
